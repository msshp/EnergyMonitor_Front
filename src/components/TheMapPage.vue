...
export default {
    ...
    mounted() {
        axios.get(`http://e-mon.io-tech.ru/api/users/${this.saveUserData.id}/devices/?limit=100000`, // запросить координаты
            {
    ...
    methods: {
        getInfoForPlaceMark() {
            axios.get('http://e-mon.io-tech.ru/api/devices/limited/?limit=10000', // запросить статусы
                {
                    headers: { 'Authorization': `Token ${sessionStorage.getItem('token')}` }
                }).then((response) => {
                    // обработка успешного запроса
        ...
        getController(id) {
            ...
            axios.get(`http://e-mon.io-tech.ru/api/devices/${id}/`,
                {
                    headers: { 'Authorization': `Token ${sessionStorage.getItem('token')}` }
                }).then((response) => {
            ...
            axios.get(`http://e-mon.io-tech.ru/api/devices/${id}/fixdata/?date_start=2024-02-01&limit=1`,
                {
                    headers: { 'Authorization': `Token ${sessionStorage.getItem('token')}` }
                }).then((response) => {
                    if (response.status === 200) {
        ...
        getErrorsForWidget(id) {
            ...
            axios.get(`http://e-mon.io-tech.ru/api/devices/${id}/event/?limit=3`,
                {
                    headers: { 'Authorization': `Token ${sessionStorage.getItem('token')}` }
                }).then((response) => {
                    if (response.status === 200) {
